...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Career Strategy & Pipeline Assessment */}
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900">Career Strategy & Pipeline Evaluation</h3>
              <p className="text-xs text-slate-500">Structured performance analysis based on your active pipeline metrics.</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-indigo-50/70 border border-indigo-100 flex items-start gap-3">
          ...
          <div className="space-y-1 text-xs sm:text-sm text-slate-700">
            <span className="font-bold text-slate-900 block">Pipeline Velocity Assessment:</span>
            <p>{defaultAssessment}</p>
          </div>
        </div>
